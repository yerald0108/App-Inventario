...
import { ItemInventario, ItemMovimiento } from '../../hooks/useDetalleTurno';
...
export default function SeccionInventarioComparadoTurno({
  inventarioInicial,
  inventarioCierre,
  entradas,
}: Props) {
  ...
  // Agrupar entradas por nombre de producto → suma total de unidades
      ...
      {nombresUnicos.map((nombre, index) => {
        ...
        return (
          ...
          >
            ...
            <Text style={[estilos.celdaValor, { color: totalEntradas > 0 ? '#38a169' : '#a0aec0', fontWeight: totalEntradas > 0 ? '700' : '400' }]}>
